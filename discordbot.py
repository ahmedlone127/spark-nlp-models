...
def crawl_discord(channel,initial_total_messages, messages_per_loop,amount_of_time_to_wait_per_loop,folder_name,number_of_loops):
	...
	worked  = False
	profile.set_preference("browser.download.dir", f"C:\\Users\\dell\\Downloads\\{folder_name}")
	...
	time.sleep(15)
	driver.find_element_by_xpath('//*[@id="dht-ctrl-track"]').click()
	driver.save_screenshot(f"C:\\Users\\dell\\Downloads\\{folder_name}\\first.png")
	driver.find_element_by_xpath('//*[@id="dht-ctrl-track"]').click()
	time.sleep(15)
	driver.find_element_by_xpath('//*[@id="dht-ctrl-track"]').click()
	driver.save_screenshot(f"C:\\Users\\dell\\Downloads\\{folder_name}\\second.png")
	time.sleep(15)
	driver.find_element_by_xpath('//*[@id="dht-ctrl-track"]').click()
	driver.save_screenshot(f"C:\\Users\\dell\\Downloads\\{folder_name}\\third.png")
	...
	for i in range(int(number_of_loops)):  
		...
		time.sleep(2)
		driver.find_element_by_xpath('//*[@id="dht-ctrl-download"]').click()
crawl_discord("https://discord.com/channels/267624335836053506/696354453724594176",2000,100,100,folder_name_,1)
list_of_jsons =(get_path(f"C:\\Users\\dell\\Downloads\\{folder_name_}",".txt"))
for text_file_ in list_of_jsons: 
	json_to_csv(text_file_)
list_of_csvs =(get_path(f"C:\\Users\\dell\\Downloads\\{folder_name_}",".csv"))
...
df.to_csv(f"C:\\Users\\dell\\Downloads\\{folder_name_}\\{folder_name_}.csv")
